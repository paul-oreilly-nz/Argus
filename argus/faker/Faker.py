...
class Faker( CommonAppFramework ):
    def __init__(self):
        ...
        self.set_limits( 
            cpu_count=random.choice([2,4,6,8,12,16,24,32,48,64])
        )
    ...
    def fake_CPU_Times_data(self):
        terms = ['user','nice','system','idle','iowait','irq','softirq','steal','guest','guest_nice']
        result = {}
        for item in terms:
